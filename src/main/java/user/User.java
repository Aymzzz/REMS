...
/**
 * Represents a user of the real estate system.
 * Each user has an associated account and can perform various actions such as viewing properties,
 * updating profile information, and interacting with properties.
 *
 * @author Hiba
 */
public class User {
 ...
 /**
     ...
     */
    public User(int id, String name, int age, String email, String phone, Account account){
        this.id = id; 
        this.name = name;
        this.age = age; 
        this.email = email;
